...
const CreateEmployee = () => {
  const [firstName, setFirstName] = useState('');
    ...
    const fetchOperation = ()=>{
      const data={firstName,lastName,age,gender,email,job,salary}; // load this in handleSubmit() from next time
      ...
      try{
        ...
        .then(responseData=>console.log('employee created successfully!'))
